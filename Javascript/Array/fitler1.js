...
console.log(produtos.filter(function(p){ // P neste caso represente cada elemento, mas poderia ser qualquer nome. Recebe 3 valores (Valor, index, array)
    return false
    // true, nenhum elemento filtrado
    // false filtrou tudo e retorna o array vazio
}))

const caro = teste1 => teste1.preco >= 500 // arrow function Produto que aponta para produto.preco
const fragil = teste1 => teste1.fragil
